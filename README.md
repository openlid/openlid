...
Inspired by [Caffeine](https://lightheadsw.com/caffeine/) and ported from
[Modafinil](https://github.com/narcotic-sh/modafinil) to Rust for a small
...
- **Display stays awake while preventing sleep** — no idle dim, no
  ...
  Caffeine uses. Opt out in Preferences if you want the screen to lock
  on idle.
...
attributions (Tabler Icons, Modafinil, Caffeine).
